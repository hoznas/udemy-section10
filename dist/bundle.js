...
define("state/project-state", ["require", "exports", "models/project", "models/project"], function (require, exports, project_js_1, project_js_2) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, manday) {
            const newProject = new project_js_1.Project(Math.random().toString(), title, description, manday, project_js_2.ProjectStatus.Active);
...
define("components/project-list", ["require", "exports", "components/base-component", "models/project", "state/project-state", "components/project-item", "decorators/autobind"], function (require, exports, base_component_js_3, project_js_3, project_state_js_2, project_item_js_1, autobind_js_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
